# skya-basic-stocktake-app

A mobile-first stocktake app where warehouse staff enter product codes and counts on the go, and instantly get a categorised stock report — no paper, no spreadsheet, no pivot table.
